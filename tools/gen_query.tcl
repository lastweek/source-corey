...
set fd [open "user/sqlitec/sqlitec_query.1001_inserts" w]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1003_inserts_in_one_trans" w]
puts $fd "\"BEGIN;\","
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1_join_wo_index" w]
puts $fd "\"SELECT count(*) FROM t1, t2 WHERE t1.b = t2.b;\","
close $fd
#runtest {100 SELECTs without an index}

#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.100_select_wo_index" w]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.100_select_on_str_comp" w]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.2_create_index" w]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1000_select_wt_index" w]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1002_update_wo_index" w]
puts $fd "\"BEGIN;\","
for {set i 0} {$i<1000} {incr i} {
  set lwr [expr {$i*10}]
  set upr [expr {($i+1)*10}]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1002_update_wt_index" w]
puts $fd "\"BEGIN;\","
for {set i 1} {$i<=1000} {incr i} {
  set r [expr {int(rand()*100000)}]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1002_txt_update_wt_index" w]
puts $fd "\"BEGIN;\","
for {set i 1} {$i<=1000} {incr i} {
  set r [expr {int(rand()*100000)}]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.4_insert_from_select" w]
puts $fd "\"BEGIN;\","
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1_delete_wo_index" w]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1_delete_wt_index" w]
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1_big_insert_after_big_delete" w]
puts $fd "\"INSERT INTO t2 SELECT * FROM t1;\","
close $fd
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.1003_big_delete_followed_by_small_insert" w]
puts $fd "\"BEGIN;\","
...
#set fd [open test$cnt.sql w]
set fd [open "user/sqlitec/sqlitec_query.2_drop_table" w]
