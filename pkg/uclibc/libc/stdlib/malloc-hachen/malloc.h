...
/*XXX. hachen never trim it. */
#ifndef DEFAULT_TRIM_THRESHOLD
#define DEFAULT_TRIM_THRESHOLD M_TRIM_THRESHOLD
#endif
...
#endif
/*see mman.h  should be after the MAP_32BITS */
#define MAP_SHARED_SEG  0x80

#ifdef __ARCH_USE_MMU__

#define MMAP(addr, size, x...) \
 u_mmap((addr), (size), (x) )
...
#define MREMAP(__addr, __old_len, __new_len,__flags,...) \
 u_mremap((__addr), (__old_len), (__new_len),(__flags))
...
#define __MALLOC_LOCK	__UCLIBC_MUTEX_LOCK(__malloc_state->__malloc_lock)
#define __MALLOC_UNLOCK	__UCLIBC_MUTEX_UNLOCK(__malloc_state->__malloc_lock)

struct malloc_state {

  __UCLIBC_MUTEX(__malloc_lock);
